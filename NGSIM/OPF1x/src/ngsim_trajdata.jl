...
const NGSIM_TRAJDATA_PATHS = [
			...
			# joinpath(@__DIR__, "../data/holo/holo_trajectories_1.txt"),
			# joinpath(@__DIR__, "../data/holo/holo_trajectories_2.txt"),
			joinpath(@__DIR__, "../data/holo_trajectories.txt"),
			# joinpath(@__DIR__, "../data/holo/holo_trajectories_4.txt"),
			# joinpath(@__DIR__, "../data/holo/holo_trajectories_5.txt"),
			# joinpath(@__DIR__, "../data/holo/holo_trajectories_6.txt"),
                       ]
